...
#define DEFAULT_LOG_PATHNAME            "/var/log/cwmpd.log"          
#define DEFAULT_LOG_LEVEL           CWMP_LOG_DEBUG   
#define DEFAULT_LOG_ENABLE          TRUE  
#define DEFAULT_LOG_ENABLE_SYS      FALSE 
...
#define MODULE_NAME_LEN     128         //module name max length
...
#ifdef WIN32
#define cwmp_log_debug(x...)          log_debug(__FILE__,__FUNCTION__, __LINE__, ##x)     
#define cwmp_log_info(x...)              log_info(__FILE__,__FUNCTION__, __LINE__, ##x)     
#define cwmp_log_error(x...)           log_error(__FILE__,__FUNCTION__, __LINE__, ##x)     
#define cwmp_log_alert(x...)            log_alert(__FILE__,__FUNCTION__, __LINE__, ##x)     
#define cwmp_log_critical(x...)         log_critical(__FILE__,__FUNCTION__, __LINE__, ##x)     
#else
